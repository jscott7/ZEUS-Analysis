...
C       ===============================================
        SUBROUTINE FINDIS96( Iopt, OutCut, Cand, Ierr ,zvtx)
C       ===============================================
C        
...
c                    Option 5 added
C       Modified     Mike Wodarczyk
C                    added zvtx as a calling parameter instead
C                    of using the VCTVTX table.
c
...
c...    Initialize
      ...
      if(first)then
         first =.false.
       WRITE(6,*) '**********************************'
       WRITE(6,*) '* This is findis96   Version 2.0 *'
...
* If intercept point greater than 5 superlayers, electron in CTD region
                     ...
                     write(6,*)'This is findis96 option 5'
...
*==>    Find among those candidates the one with highest E
      ...
      Else
       Write(6,*) 'FINDIS96: Option not yet implemented'
      EndIf
