      SUBROUTINE NOISE96S(RUN,ECUT,IMBACUT,NSIGMA,
...
C------  A.Savin
        ...
        open(15,file=
     &'/zow/userc/savin/NOISE96/noscell95.list',status='old')
        goto 10
        endif
        if(run.gt.20000 .and. run.lt.30000)then
C_AB        open(15,file=
C_AB     &'/zow/userc/savin/NOISE96/noscell96.list',status='old')
        open(15,file=
     &'/zow/userc/savin/NOISE96/noscell96.03-60.list',status='old')
        goto 10
        endif
