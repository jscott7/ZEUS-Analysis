...
c ------------------------------------------
	...
	if (log10(y_tru).gt.-1.7.and.log10(y_tru).le.-1.55) then
          call hf1(430,temp2,mcwt2)
      elseif (log10(y_tru).gt.-1.55.and.log10(y_tru).le.-1.4) then
        call hf1(431,temp2,mcwt2)
      elseif (log10(y_tru).gt.-1.4.and.log10(y_tru).le.-1.25) then
        call hf1(432,temp2,mcwt2)
      elseif (log10(y_tru).gt.-1.25.and.log10(y_tru).le.-1.1) then
	        call hf1(433,temp2,mcwt2)
      elseif (log10(y_tru).gt.-1.1.and.log10(y_tru).le.-0.95) then
	        call hf1(434,temp2,mcwt2)
      elseif (log10(y_tru).gt.-0.95.and.log10(y_tru).le.-0.8) then
	        call hf1(435,temp2,mcwt2)
      elseif (log10(y_tru).gt.-0.8.and.log10(y_tru).le.-0.65) then
	        call hf1(436,temp2,mcwt2)
      elseif (log10(y_tru).gt.-0.65.and.log10(y_tru).le.-0.5) then
	        call hf1(437,temp2,mcwt2)
      elseif (log10(y_tru).gt.-0.5.and.log10(y_tru).le.-0.35) then
	        call hf1(438,temp2,mcwt2)
      elseif (log10(y_tru).gt.-0.35.and.log10(y_tru).le.-0.2) then
